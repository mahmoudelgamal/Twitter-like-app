let users = {
  ...
  Mahmoud_Elgamal: {
    id: "Mahmoud_Elgamal",
    name: "Mahmoud Elgamal",
    avatarURL: "https://scontent-hbe1-1.xx.fbcdn.net/v/t1.0-9/29028199_1490237591105766_7558918419760807936_n.jpg?_nc_cat=109&_nc_oc=AQnxhj_B7-DC03tBFlLOQP9okH8nU3drj4d4jTbPoLW5C-94rzJfa6nxEafxamtoVME&_nc_ht=scontent-hbe1-1.xx&oh=144961fc7c341652af4cc1bbc77223ae&oe=5EB23C5B",
...
let tweets = {
  ...
  "czpa59mg577x1oo45cup0d": {
    ...
    author: "dan_abramov",
    timestamp: 1515043995650,
    likes: ['Mahmoud_Elgamal', 'sarah_edo'],
  ...
  "6h5ims9iks66d4m7kqizmv": {
    ...
    likes: ['dan_abramov', 'Mahmoud_Elgamal'],
  ...
  "sfljgka8pfddbcer8nuxv": {
    ...
    likes: ['sarah_edo', 'Mahmoud_Elgamal'],
    replyingTo: "hbsc73kzqi75rg7v1e0i6a",
    replies: [],
  },
